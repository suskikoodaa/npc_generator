...
def generate_npc(region, room):
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a fantasy room generator."},
            {"role": "user", "content": "region=Shire from Lord of the Rings, room=Bilbo's house, wall=w, door=d, table=t, chair=c"},
